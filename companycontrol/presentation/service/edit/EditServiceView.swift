    ...
    var body: some View {
        NavigationView {
            ...
            .onAppear {
                ...
                self.amount = formatter.string(from: NSNumber(value: service.amount)) ?? ""
                self.selectedOption = service.expenseCategory.name
                self.categiroryId = service.expenseCategory.id
                self.selectedCompanyOption = service.company.name
                self.companyId = service.company.id
                self.date = service.date.toDate()
